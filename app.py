...
st.set_page_config(page_title="Uzun Kod — v13 / Statik", page_icon="🧩", layout="wide", initial_sidebar_state="collapsed")
st.markdown("""
<style>
...
with header:
    ...
    with left:
        st.title("Uzun Kod Oluşturma Programı - v13 / Statik")
...
EMOJI = {
    "ELK":"⚡", "ELEKTRİK":"⚡",
    "ACICI_TIPI":"🧰", "AÇICI TIPI":"🧰",
    "CIFT_KAFA":"🔁", "ÇİFT KAFA":"🔁",
    "SAC_GEN":"📐","SAC GENİŞLİĞİ":"📐",
    "DISCAP":"📏","DIŞ ÇAP":"📏",
    "TAHRIK":"⚙️","TAMBUR":"🎛️","MERKEZLEME":"🎯","YUKLEME ARABASI":"🛻","HIDROLIK UNITE":"🛢️","SENSOR":"📡","LOOP KONTROL":"🔄"
}
